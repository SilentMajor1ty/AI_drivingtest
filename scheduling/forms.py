...
# --- Вынесенная функция проверки конфликтов ---
...
class LessonForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if all([lesson_date, start_time, duration_minutes]):
            ...
            if teacher:
                conflict_error = check_lesson_conflicts(teacher, start_datetime_utc, end_datetime, exclude_lesson_id=self.instance.pk if self.instance else None)
                if conflict_error:
